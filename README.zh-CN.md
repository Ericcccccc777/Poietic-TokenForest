...
| 把状态存在本地小文件里 | 连接网络——除非你主动开启排行榜、价格表更新或更新检查（三者默认全关） |
...
不需要。所有功能完全离线可用。会联网的可选功能是排行榜、价格表更新和更新检查——每一个都默认关闭、需要你主动开启，而且只有排行榜会上传内容。各自具体发送什么见[隐私声明](docs/PRIVACY.zh-CN.md)。
